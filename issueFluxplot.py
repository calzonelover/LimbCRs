...
Glimb.SetTitle('oldlimb : #theta_{nadir} 68.4-70.0 : #gamma = %f'%glimb)
...
G1.SetTitle('set 1 : #theta_{nadir} 66.0-70.0 (include earth) : #gamma = %f'%g1)
G1.SetMarkerStyle(22)
G1.SetMarkerColor(2)
G1.SetLineColor(2)
G1.Draw('E1same')
G2.SetTitle('set 2 : #theta_{nadir} 68.20-70.0 (mean) : #gamma = %f'%g2)
G2.SetMarkerStyle(33)
G2.SetMarkerColor(4)
G2.SetLineColor(4)
G2.Draw('E1same')
G3.SetTitle('set 3 : #theta_{nadir} 68.02-70.0 (peak) : #gamma = %f'%g3)
