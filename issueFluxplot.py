...
# fit
F=TF1('F','[0]*(x**[1])',10.,1000.)
F.SetParameter(0,-2.7)
F.SetParameter(1,1.)
Glimb.Fit('F','R')
glimb=F.GetParameter(1)
eglimb=F.GetParError(1)
chiglimb=F.GetChisquare()
G1.Fit('F','R')
g1=F.GetParameter(1)
eg1=F.GetParError(1)
chig1=F.GetChisquare()
G2.Fit('F','R')
g2=F.GetParameter(1)
eg2=F.GetParError(1)
chig2=F.GetChisquare()
G3.Fit('F','R')
g3=F.GetParameter(1)
eg3=F.GetParError(1)
chig3=F.GetChisquare()
#
...
Glimb.SetTitle('oldlimb : #theta_{nadir} 68.4-70.0 : #gamma = %f #pm %f, #chi^{2}=%f'%(glimb,eglimb,chiglimb))
...
G1.SetTitle('set 1 : #theta_{nadir} 66.0-70.0 (include earth) : #gamma = %f #pm %f, #chi^{2}=%f'%(g1,eg1,chig1))
G1.SetMarkerStyle(22)
G1.SetMarkerColor(2)
G1.SetLineColor(2)
G1.Draw('E1same')
G2.SetTitle('set 2 : #theta_{nadir} 68.20-70.0 (mean) : #gamma = %f #pm %f, #chi^{2}=%f'%(g2,eg2,chig2))
G2.SetMarkerStyle(33)
G2.SetMarkerColor(4)
G2.SetLineColor(4)
G2.Draw('E1same')
G3.SetTitle('set 3 : #theta_{nadir} 68.02-70.0 (peak) : #gamma = %f #pm %f, #chi^{2}=%f'%(g3,eg2,chig3))
