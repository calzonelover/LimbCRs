...
int main(int argc, char **argv)
{
    ...
    spl->SetParameter(0, 2.26008);
    spl->FixParameter(1, 2.62515 - multiplicative);

    TF1 *bpl = new TF1("BrokenPowerLaw", Formula::bpl, 60, 2000, 4);
    bpl->SetParameter(0, 4.04837);
    bpl->FixParameter(1, 2.90502 - multiplicative);
    bpl->FixParameter(2, 2.65259 - multiplicative);
    bpl->FixParameter(3, 326.956);
